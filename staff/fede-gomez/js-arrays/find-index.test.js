...
tests.push(function () {
    console.log('Should succeed on searching inside an array and returning the index of the elemen that satisfies the condition, and if not exists, returning -1');
