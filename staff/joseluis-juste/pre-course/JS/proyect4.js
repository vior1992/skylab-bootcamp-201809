...
function Player(_name) {
	...
	this.processRound = function (numRonda = 1, repeticion = false) {

		var question;
		var resp = "";
		var repetirRonda = false;

		if (!repeticion) {

			console.log("Comienza la ronda " + numRonda + " de preguntas para el jugador " + this.name);
			console.log("-------------------------------------------------------------------------------");
			console.log("");

		} else {

			console.log(numRonda + "ª ronda de preguntas dado que el jugador " + this.name + " pasó palabras en la ronda anterior");
			console.log("");
		}
		...
		for (var letter in this.letters) {
			...
			repetirRonda = (this.letters[letter] === "") || false;

			if (repetirRonda) {
				numRonda++;
				this.processRound(numRonda, true);
			}
		}
...
function getPlayers(numPlayers, players) {
...
function mainProgram() {
	...
	do {
		...
		numPlayers = null;
		resp = "";
		numPlayers = prompt("¿Cuantos jugadores quiere que participen...?");
		if ((numPlayers === null) || (numPlayers === "") || (isNaN(numPlayers))) {
