...
tests.push(function() {
	...
	if (error.message !== "null is not an array") throw Error('should have thrown "object is not an array!", but got: ' + error.message);
...
tests.push(function() {
	...
	if (error.message !== str + ' is not an array') throw Error('should have thrown ' +  str + ' is not an array", but got: ' + error.message);
...
tests.push(function() {
	...
	if (error.message !== " is empty") throw Error("should have thrown `error: one argument is empty´, but got: " + error.message);
})
