...
tests.push(function(){
    console.log("should succeessfully remove last item");
...
tests.push(function(){
	...
	if (error.message !== nums + ' is empty') throw Error('should have thrown "array is empty", but got: ' + error.message);

});

/* Test not work as real pop
tests.push(function(){
