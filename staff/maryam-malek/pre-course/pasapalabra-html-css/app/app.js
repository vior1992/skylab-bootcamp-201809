...
function pasapalabra(){
    ...
    function preguntes (){
        ...
        if(respostes === questions.length){
            document.getElementById("comment").innerHTML =('Ya has respondido a todas las preguntas... y tu puntuación es de ... ' + points + ' puntos!');  
            showPoints();
        }else{
            document.getElementById("comment").innerHTML =('Vamos a por la siguiente ronda!')
            nuevaRonda();
        }   
    ...
    function showPoints(){
        console.log('He entrat a showPoints()')
